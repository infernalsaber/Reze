...
@walkthrough.command
@lb.command("walkthrough", "Get a walktrhough using the bot", )
...
async def walkthrough_cmd(ctx: lb.Context) -> None:
    ...
    pages.append(
        hk.Embed(
            title="Lookup",
            description="Lookup anime, manga or characters"
        )
    ...
    pages.append(
        hk.Embed(
            title="Subreddit",
            description="Get hot posts from a sr, or multiple"
        )
    ...
    pages.append(
        hk.Embed(
            title="3x3",
            description="Fast af 3x3 maker"
        )
        .set_image("https://i.imgur.com/81SCLlr.png")
    )
    #Reminders
    pages.append(
        hk.Embed(
            title="Reminder",
            description="Set a reminder. Eg. -rm sleep in 1h4m"
        )
    ...
    pages.append(
        hk.Embed(
            title="Image Tools",
            description="Fun/useful image modifications"
        )
    ...
    pages.append(
        hk.Embed(
            title="Color",
            description="Get a color and its info"
        )
        .set_image("https://i.imgur.com/ymqZyvy.png")
    )
    #Plot
    pages.append(
        hk.Embed(
            title="Plot graphs",
            description="Make cool comparision graphs"
        )
